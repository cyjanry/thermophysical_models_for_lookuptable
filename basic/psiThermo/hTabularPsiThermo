...
#include "hTabularPsiThermo.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class MixtureType>
void Foam::hTabularPsiThermo<MixtureType>::calculate()
{
...
template<class MixtureType>
Foam::hTabularPsiThermo<MixtureType>::hTabularPsiThermo(const fvMesh& mesh, const objectRegistry& obj)
:
...
template<class MixtureType>
Foam::hTabularPsiThermo<MixtureType>::~hTabularPsiThermo()
{}
...
template<class MixtureType>
void Foam::hTabularPsiThermo<MixtureType>::correct()
{
    if (debug)
    {
        Info<< "entering hTabularPsiThermo<MixtureType>::correct()" << endl;
    }
    ...
    if (debug)
    {
        Info<< "exiting hTabularPsiThermo<MixtureType>::correct()" << endl;
    }
}


template<class MixtureType>
Foam::tmp<Foam::scalarField> Foam::hTabularPsiThermo<MixtureType>::h
(
 const scalarField& p,
    const scalarField& T,
...
template<class MixtureType>
Foam::tmp<Foam::scalarField> Foam::hTabularPsiThermo<MixtureType>::Cp
(
 const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::hTabularPsiThermo<MixtureType>::Cp() const
{
...
template<class MixtureType>
Foam::tmp<Foam::scalarField> Foam::hTabularPsiThermo<MixtureType>::Cv
(
 const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::hTabularPsiThermo<MixtureType>::Cv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class MixtureType>
bool Foam::hTabularPsiThermo<MixtureType>::read()
{
